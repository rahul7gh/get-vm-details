...
output={"ipaddress":args.ipaddress,"machine_name":args.machine_name,"cpu":"2","memory":"16384MB","disk":"131072MB","instance_type":args.instance_type,"env":args.env,"status":"ON"}
